...
/obj/machinery/mineral/wasteland_vendor/weapons
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Cowboy Repeater",				/obj/item/gun/ballistic/rifle/cowboy,						160),
	...
	highpop_list = list(
		...
		new /datum/data/wasteland_equipment("Cowboy Repeater",				/obj/item/gun/ballistic/rifle/cowboy,						80),
